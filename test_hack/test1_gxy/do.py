...
time3 = 0
orderdict = {}
orderdict['peo1'] = ['java -classpath ./peo1/out MainClass']
orderdict['peo2'] = ['java -classpath ./peo2/out MainClass']
orderdict['peo3'] = ['java -classpath ./peo3/out MainClass']
orderdict['peo4'] = ['java -classpath ./peo4/out MainClass']
orderdict['peo5'] = ['java -classpath ./peo5/out Main']
orderdict['peo6'] = ['java -classpath ./peo6/out MainClass']
orderdict['peo7'] = ['java -classpath ./peo7/out Main']
while (1):
    pre = time.time()
    ...
    gxy = open("gxy.txt", "w")
    gsw = open("gsw.txt", "w")
    p1 = subprocess.Popen('java -classpath ./peo1/out MainClass', stdin=inp, stdout=gxy)
    p2 = subprocess.Popen('java -classpath ./peo4/out MainClass', stdin=inp2, stdout=gsw)
